...
# This is an ad-hoc generator-based version of the DataSet class,
# because I can't load my entire training set into memory. Clearly
...
class DataSetGenerator():
  def __init__(self, data_root):
    ...
    random.shuffle(self.XY_meta) # should w elet keras do this?
  ...
  def generate_data(self, frames=90, first_n=None):
      '''
      Loads the video data into memory.
      '''
      while True: # keras generators need to be infinitely iterable (or at least # epochs * stepe per epoch)
        for video_path, y_label in self.XY_meta:
            ...
            encoded_label = DataSet.encode([y_label], classes=self.classes)
            #print(encoded_label)
